...
var Confirmation = function () {
    ...
    var Default = $.extend({}, $.fn.popover.Constructor.Default, {
        ...
        btnOkLabel: '<i class="fa fa-check"></i>&nbsp; Yes</a>',
        btnCancelClass: 'btn-outline-info',
        btnCancelLabel: '<i class="fa fa-times"></i>&nbsp; No</a>',
        // @formatter:off
        // href="#" allows the buttons to be focused
        template: '<div class="popover confirmation">' +
            '<div class="arrow"></div>' +
            '<p class="popover-header py-1 small" style="font-size:14px;"></p>' +
            '<div class="popover-body">' +
            '<p class="confirmation-content"></p>' +
            '<div class="confirmation-buttons text-center">' +
            '<div class="btn-group btn-group-sm small" role="group">' +
            '<a href="#" class="btn btn-sm small py-1" style="font-size:12px;" data-apply="confirmation"></a>' +
            '<a href="#" class="btn btn-sm small py-1" style="font-size:12px;" data-dismiss="confirmation"></a>' +
            '</div>' +
            '</div>' +
            '</div>' +
            '</div>'
    ...
    var DefaultType = _extends({}, $.fn.popover.DefaultType, {
        ...
        /* overriding tooltip's '(string|element|function)' type */
        singleton: 'boolean',
        popout: 'boolean',
    ...
    function getUID(prefix) {
        do {
            prefix += ~~(Math.random() * 1000000 /* MAX_UID */ );
